...
def main():
    ...
    _FETCH_SOURCES = {"NEDO", "JST", "PORTAL", "JOGMEC", "AICHI", "TOKYO", "OSAKA", "FUKUOKA",
                       ...
                       "TOCHIGI", "CHIBA", "KYOTO", "HYOGO", "SHIGA", "WAKAYAMA", "HIROSHIMA", "OKAYAMA", "EHIME", "KOCHI", "SAGA", "SHIMANE", "KUMAMOTO", "HOKKAIDO", "TOKUSHIMA", "NAGASAKI", "OKINAWA", "OITA", "AKITA", "FUKUSHIMA", "TOTTORI", "GUNMA", "SAITAMA", "IWATE", "KAGAWA", "YAMAGATA", "YAMAGUCHI"}
    ...
    _FETCH_PRIORITY = {"AICHI": 0, "TOKYO": 0, "OSAKA": 0, "FUKUOKA": 0, "MIE": 0, "GIFU": 0,
                       ...
                       "NIIGATA": 0, "TOCHIGI": 0, "CHIBA": 0, "KYOTO": 0, "HYOGO": 0, "SHIGA": 0, "WAKAYAMA": 0, "HIROSHIMA": 0, "OKAYAMA": 0, "EHIME": 0, "KOCHI": 0, "SAGA": 0, "SHIMANE": 0, "KUMAMOTO": 0, "HOKKAIDO": 0, "TOKUSHIMA": 0, "NAGASAKI": 0, "OKINAWA": 0, "OITA": 0, "AKITA": 0, "FUKUSHIMA": 0, "TOTTORI": 0, "GUNMA": 0, "SAITAMA": 0, "IWATE": 0, "KAGAWA": 0, "YAMAGATA": 0, "YAMAGUCHI": 0,
    ...
    for r in targets[:MAX_DETAIL_PER_RUN]:
        ...
        if src == "JST":
            ...
            info = fetch_saitama_detail(r["url"])
        elif src == "IWATE":
            info = fetch_iwate_detail(r["url"])
        elif src == "KAGAWA":
            info = fetch_kagawa_detail(r["url"])
        elif src == "YAMAGATA":
            info = fetch_yamagata_detail(r["url"])
        elif src == "YAMAGUCHI":
            info = fetch_yamaguchi_detail(r["url"])
        else:
