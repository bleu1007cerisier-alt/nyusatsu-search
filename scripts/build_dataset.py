...
from scraper import (  # noqa: E402
    ...
    fetch_tochigi_detail, fetch_chiba_detail, fetch_kyoto_detail, fetch_hyogo_detail, fetch_shiga_detail, fetch_wakayama_detail, fetch_hiroshima_detail,
)
...
def main():
    ...
    _FETCH_SOURCES = {"NEDO", "JST", "PORTAL", "JOGMEC", "AICHI", "TOKYO", "OSAKA", "FUKUOKA",
                       ...
                       "TOCHIGI", "CHIBA", "KYOTO", "HYOGO", "SHIGA", "WAKAYAMA", "HIROSHIMA"}
    ...
    _FETCH_PRIORITY = {"AICHI": 0, "TOKYO": 0, "OSAKA": 0, "FUKUOKA": 0, "MIE": 0, "GIFU": 0,
                       ...
                       "NIIGATA": 0, "TOCHIGI": 0, "CHIBA": 0, "KYOTO": 0, "HYOGO": 0, "SHIGA": 0, "WAKAYAMA": 0, "HIROSHIMA": 0,
