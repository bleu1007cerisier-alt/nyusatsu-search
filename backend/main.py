...
DEV_SOURCES = [
    ...
    {"code": "SAGA", "label": "佐賀県",
     "url": "https://www.pref.saga.lg.jp/list02043.html",
     "desc": "佐賀県の入札公告（委託・物品）"},
    {"code": "KOCHI", "label": "高知県",
     "url": "https://www.pref.kochi.lg.jp/category/bunya/shigoto_sangyo/nyusatsujoho/",
     "desc": "高知県の入札情報（公告一覧）"},
    {"code": "MIYAZAKI", "label": "宮崎県",
     "url": "https://www.e-nyusatsu-joho.pref.miyazaki.lg.jp/ebidPPIPublish/EjPPIj",
     "desc": "宮崎県 電子入札情報公開システムの入札公告（工事・測量コンサル）"},
    {"code": "SHIMANE", "label": "島根県",
     "url": "https://www.pref.shimane.lg.jp/bid_info/rireki_list.html",
     "desc": "島根県の入札情報（過去の入札情報一覧・全部局）"},
    {"code": "KUMAMOTO", "label": "熊本県",
     "url": "https://www.pref.kumamoto.jp/life/sub/5/index-2.html",
     "desc": "熊本県の入札情報一覧（全部局の入札・公募）"},
    {"code": "HOKKAIDO", "label": "北海道",
     "url": "https://www.pref.hokkaido.lg.jp/news/nyusatsu/",
     "desc": "北海道の入札情報（全部局の入札公告・公募・プロポーザル）"},
    {"code": "TOKUSHIMA", "label": "徳島県",
     "url": "https://www.pref.tokushima.lg.jp/mokuteki/nyusatsu/news/",
     "desc": "徳島県の入札・調達・売却の新着情報（全部局）"},
    {"code": "NAGASAKI", "label": "長崎県",
     "url": "https://www.pref.nagasaki.jp/nyusatsu-docs/",
     "desc": "長崎県の入札情報（業務委託・売却の公告/結果）"},
    {"code": "OKINAWA", "label": "沖縄県",
     "url": "https://www.pref.okinawa.jp/shigoto/nyusatsukeiyaku/1015342/index.html",
     "desc": "沖縄県の公募・入札発注情報（委託・プロポ等、現年度）"},
    {"code": "OITA", "label": "大分県",
     "url": "https://www.pref.oita.jp/site/nyusatu-koubo/",
     "desc": "大分県の入札・公募情報（企画提案・委託等）"},
    {"code": "AKITA", "label": "秋田県",
     "url": "https://www.pref.akita.lg.jp/pages/genre/12231",
     "desc": "秋田県のコンペ・入札情報（企画提案競技・委託等）"},
    {"code": "FUKUSHIMA", "label": "福島県",
     "url": "https://www.pref.fukushima.lg.jp/sec/list10-1.html",
     "desc": "福島県の入札・契約情報（全部局の入札・公募）"},
    {"code": "TOTTORI", "label": "鳥取県",
     "url": "https://www.pref.tottori.lg.jp/9511.htm",
     "desc": "鳥取県のその他入札情報（調達公告・委託・プロポ）"},
    {"code": "GUNMA", "label": "群馬県",
     "url": "https://www.pref.gunma.jp/site/nyuusatsu/",
     "desc": "群馬県の入札・公募情報（プロポ・委託・物品等）"},
    {"code": "SAITAMA", "label": "埼玉県",
     "url": "https://www.pref.saitama.lg.jp/kense/tetsuzuki/shinchaku/index.html",
     "desc": "埼玉県の新着入札情報（企画提案競技・委託等）"},
    {"code": "IWATE", "label": "岩手県",
     "url": "https://www.pref.iwate.jp/news/1016275.html",
     "desc": "岩手県の入札・公募 新着更新情報一覧（全部局）"},
    {"code": "KAGOSHIMA", "label": "鹿児島県",
     "url": "https://www.kagoshima-nyusatsu.jp/ebidPPIPublish/EjPPIj",
     "desc": "鹿児島県 電子入札システムの入札公告（工事・測量コンサル）"},
    {"code": "KAGAWA", "label": "香川県",
     "url": "https://www.pref.kagawa.lg.jp/cgi-bin/page/list.php?tpl_type=2&page_type=5",
     "desc": "香川県の入札一覧（全部局の入札・公募）"},
    {"code": "AOMORI", "label": "青森県",
     "url": "http://pub.pref.aomori.lg.jp/pls/doboku/",
     "desc": "青森県の建設工事・委託の入札情報（現在開札前）"},
    {"code": "YAMAGATA", "label": "山形県",
     "url": "https://www.pref.yamagata.jp/kensei/nyuusatsujouhou/nyuusatsujouhou/proposal/index.html",
     "desc": "山形県の公募型プロポーザル・業務委託の入札情報"},
    {"code": "YAMAGUCHI", "label": "山口県",
     "url": "https://www.pref.yamaguchi.lg.jp/life/sub/5/index-2.html",
     "desc": "山口県の入札情報（公募型プロポーザル等）"},
    {"code": "EHIME", "label": "愛媛県",
     "url": "https://www.pref.ehime.jp/site/nyusatsu/list92-339.html",
     "desc": "愛媛県の入札情報（物品・委託等）"},
    {"code": "OKAYAMA", "label": "岡山県",
     "url": "https://www.pref.okayama.jp/site/321/list328.html",
     "desc": "岡山県の入札公告（業務委託・物品）"},
    {"code": "HIROSHIMA", "label": "広島県",
     "url": "https://www.pref.hiroshima.lg.jp/site/nyusatsukeiyaku/list945-4044.html",
     "desc": "広島県の入札公告（物品・委託役務・電子入札）"},
    {"code": "WAKAYAMA", "label": "和歌山県",
     "url": "https://www.pref.wakayama.lg.jp/whatsnew/nyusatsu.html",
     "desc": "和歌山県の入札・物品・役務（新着一覧）"},
    {"code": "SHIGA", "label": "滋賀県",
     "url": "https://www.pref.shiga.lg.jp/zigyousya/nyusatsubaikyaku/itaku/",
     "desc": "滋賀県の公告一覧（物品・委託・役務・プロポーザル）"},
